            ...
            {submitted ? (
              ...
              <div className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full bg-purple-600 text-white py-4 rounded-lg font-semibold hover:bg-purple-700 transition shadow-lg hover:shadow-xl flex items-center justify-center"
                >
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="text-left text-purple-600 hover:text-purple-700 font-medium">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="flex space-x-4">
                <button className="bg-purple-600 text-white p-3 rounded-lg hover:bg-purple-700 transition">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-gray-300 rounded-lg h-96 flex items-center justify-center">
            <div className="text-center text-gray-600">
              ...
              <p className="text-sm">Google Maps or similar would be displayed here</p>
            </div>
          </div>
        </div>
      </section>
