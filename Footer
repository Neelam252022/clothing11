...
export default function Footer({ categories, navigateToCategory, navigateToPage }) {
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your destination for premium fashion and jewelry. 
              Curated collections that define elegance and style.
            </p>
            <div className="mt-4 flex space-x-4">
              <button className="text-gray-400 hover:text-white transition" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </button>
              <button className="text-gray-400 hover:text-white transition" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button className="text-gray-400 hover:text-white transition" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4 text-sm">
              Subscribe to our newsletter for exclusive offers and latest arrivals.
            </p>
            <div className="flex flex-col space-y-2">
              ...
              <button 
                ...
                className="bg-purple-600 px-4 py-2 rounded-lg hover:bg-purple-700 transition font-semibold"
              >
                Subscribe
              </button>
            </div>
